...
const subjects = ["У меня проблема", "У меня важный вопрос"];

const snacks = [{ i: "пицца", l: "Пиццу" }, { i: "пирог", l: "Пирог" }];
  ...
  const cs = (
    <div className="contact-form__input-group">
      <input
        ...
        id={"salutation-" + salutations[0].abbr}
        name="salutation"
        type="radio"
        value={salutations[0].text}
        checked={s === salutations[0].text}
      />
      <label
      ...
      <input
        className="contact-form__input contact-form__input--radio"
        id={"salutation-" + salutations[1].abbr}
        name="salutation"
        type="radio"
        value={salutations[1].text}
        checked={s === salutations[1].text}
      />
      <label
        className="contact-form__label contact-form__label--radio"
        htmlFor={"salutation-" + salutations[1].abbr}
      >
        {salutations[1].text}
      </label>
      <input
        className="contact-form__input contact-form__input--radio"
        id={"salutation-" + salutations[2].abbr}
        name="salutation"
        type="radio"
        value={salutations[2].text}
        checked={s === salutations[2].text}
      />
      <label
        className="contact-form__label contact-form__label--radio"
        htmlFor={"salutation-" + salutations[2].abbr}
      >
        {salutations[2].text}
      </label>
    </div>
    ...
    <div className="contact-form__input-group">
      ...
      >
        {subjects.map((v, i) => {
          let k = "opt" + v;
          return (
            <option key={k} value={k} selected={h === v}>
              {v}
            </option>
          );
        })}
